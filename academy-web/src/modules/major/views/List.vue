        ...
        <v-data-table :headers="headers"
                      ...
                      class="elevation-1">
                        ...
                        <template v-slot:[`item.action`]="{ item }">
                            <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                    <v-btn icon v-on="on" @click="$router.push({ name: 'update-major', params: { id: item.id } })">
                                        <v-icon>
                                            mdi-pencil
                                        </v-icon>
                                    </v-btn>
...
<script>
    // Services
    import { getMajorAll } from "@/services/major.js";
    ...
    export default {
        ...
        data() {
            return {
                ...
                loading: true,                
                headers: [
                    { text: 'Name Major', value: 'name', sortable: true},
