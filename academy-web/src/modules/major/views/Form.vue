<template>
           <div>
               <v-card :loading="events.loading">
                   ...
                   <v-card-actions>
                       <v-spacer></v-spacer>
                       <v-btn color="primary" outlined @click="$router.push({ name: `major`})" :disabled="events.loading">
                           Back
                       </v-btn>
       ...
       <script>
           // Services
           import { createMajor, getMajorDetail, updateMajor } from "@/services/major.js";
           ...
           export default {
               ...
               data() {
                   return {
                       ...
                       rules: {
                                 name: [ v => !!v || 'Name Major is required' ],
                       },
                       form_submit: {},
                       loading: false,
                       form_mode: null,
               ...
               methods:{
                   doGetMajorDetail() {
                       ...
                       getMajorDetail(this.$route.params.id)
                           .then((response) => {
                               this.events.loading = false;
                               this.form = response;
                           }).catch((error) => {
                   ...
                   async doCreate() {
                       this.events.loading = true;
                       await createMajor(this.form_submit)
                           .then(() => {
