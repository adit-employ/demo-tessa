        ...
        <v-data-table :headers="headers"
                      ...
                      class="elevation-1">
                        ...
                        <template v-slot:[`item.action`]="{ item }">
                            <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                    <v-btn icon v-on="on" @click="$router.push({ name: 'update-technology', params: { id: item.id } })">
                                        <v-icon>
                                            mdi-pencil
                                        </v-icon>
                                    </v-btn>
...
<script>
    // Services
    import { getTechnologyAll } from "@/services/technology.js";
    ...
    export default {
        name: "VueListTechnology",
        data() {
            return {
                search: null,
                loading: true,                
                headers: [
                    { text: 'Name Technology', value: 'name', sortable: true},
