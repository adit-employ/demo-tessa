        ...
        <v-data-table :headers="headers"
                      ...
                      class="elevation-1">
                        ...
                        <template v-slot:[`item.action`]="{ item }">
                            <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                    <v-btn icon v-on="on" @click="$router.push({ name: 'update-brand', params: { id: item.id } })">
                                        <v-icon>
                                            mdi-pencil
                                        </v-icon>
                                    </v-btn>
...
<script>
    // Services
    import { getBrandAll } from "@/services/brand.js";
    ...
    export default {
        ...
        data() {
            return {
                ...
                loading: true,                
                headers: [
                    { text: 'Name Brand', value: 'name', sortable: true},
