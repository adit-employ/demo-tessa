<template>
           <div>
               <v-card :loading="events.loading">
                   ...
                   <v-card-actions>
                       <v-spacer></v-spacer>
                       <v-btn color="primary" outlined @click="$router.push({ name: `emailbast`})" :disabled="events.loading">
                           Back
                       </v-btn>
           ...
           export default {
               ...
               methods:{
                   ...
                   async doSave() {
                       ...
                       this.form_submit.emailType = "BAST";
                   ...
                   saveSuccess() {
                       ...
                       this.$notify({
                           title: "Successful",
                           content: "Email BAST already saved!",
                           color: "rgb(0, 200, 83)",
                       });
                       this.$router.push({ name: `emailbast` });
                   }
               }
           }
       </script>