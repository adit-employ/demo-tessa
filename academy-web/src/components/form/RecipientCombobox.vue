<template>
    <v-combobox v-model="selected"
        ...
        <template v-slot:selection="data">
            <v-chip v-bind="data.attrs" v-if="getInitial(data.item) !== null"
        ...
        <template v-slot:item="data">
            ...
            <template v-else >
                ...
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle v-html="data.item.roleMapping.roleName"></v-list-item-subtitle>
                </v-list-item-content>
            </template>
        </template>
    </v-combobox>
...
<script>
    export default {
        ...
        methods: {
            ...
            onInput() {
                // if(this.getInitial(this.selected) != null && (this.search.trim() === '' || this.search.trim() === null)) {
